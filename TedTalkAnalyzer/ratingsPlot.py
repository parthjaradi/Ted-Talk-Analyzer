...
#Function to create graph for Number of Talks Vs Ratings
import numpy as np
...
def ratingsPlot(dataset,counter,neg_descriptors):
    ...
    bar = plt.bar(indices, frequencies, 0.8,color=['teal', 'tomato', 'violet', 'turquoise','salmon' ,'orchid','lightgreen'])
